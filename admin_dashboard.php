...
header, footer {
    ...
    background: rgba(0,0,0,0.3); width: 100%; backdrop-filter: blur(8px);
}
.container {
    width: 90%; max-width: 900px;
    margin: 30px auto; background: rgba(255,255,255,0.2);
    padding: 20px; border-radius: 15px; backdrop-filter: blur(10px); color: white;
}
table {
    width: 100%; border-collapse: collapse; margin-top: 20px; color: white;
}
th, td {
    padding: 12px; border-bottom: 1px solid white; text-align: left;
}
th { background: rgba(255,255,255,0.3); border-radius: 8px; }
a.btn {
...
.logout {
    float: right; margin-right: 20px; color: white; text-decoration: none;
}
